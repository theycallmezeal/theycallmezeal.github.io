...
fire, flower, lake, moon, mountain, nature, ocean, rain, river, sky, star, sun, tree, world

#### Weather

cloud, cloudy, degree, snow, sunny, temperature, weather, wind, windy
...
language, mean (to have a meaning), meaning, sentence, topic, translate, word

#### Time

afternoon, autumn, birthday, date, day (span of time), day (time of day), future, holiday, hour, last night, minute, month, morning, night / evening, noon, o'clock, past, season, second, spring, summer, time (an instance), time (in general), today, tomorrow, tonight, week, weekday, weekend, winter, year, yesterday
...
big, clean (adj.), closed, cold, cool (temperature), dirty, empty, fast, full (not empty), hard (not soft), heavy, hot, light (bright), light (not heavy), long, loud, low, off (of a switch), on (of a switch), open, round, short, slow, small, soft, straight, tall, thick, thin, to be made of, type (kind), warm
...
agree, answer (n.), answer (v.), ask, ask for, call (identify), call (on the phone), conversation, describe, explain, let someone know, question, recommend, reply, say, speak, talk, tell (someone), thank
...
above, area, around, at, away (not here), back (direction), back (location), be located, behind, between, bottom, by (a place), close (to), corner, down(wards), far, forward, from, front, ground, here, in, in front of, inside, left (direction), middle, next to, on, out of, outside, outside of, over (above), over there, place, right (direction), room (for something), side, spot, there, through, to, top, under(neath), up(wards), way (route), west

#### Describing time

after(wards), ago, at (a time), away (distance), back then, before, by (a time), during, early, eventually, for (a duration), for a little bit, for a long time, immediately, in a while, in a bit, just (recently), late, later, miss, next (on the next occasion), now, nowadays, on the way, on time, once (in the past), over (of an event), recently, since, so far, someday, soon, spend time, take (an amount of time), then (at that time), until, while
...
as (comparisons), difference, different, exactly, less, like (similar to), most (as in "the most"), opposite, same, similar to, than
...
have to, let, make (somebody do something), may (permission), not allowed, should
...
for how long, how, how &lt;adjective&gt;, how many, what, what about, what kind of, what time, when, where, which, who, why
